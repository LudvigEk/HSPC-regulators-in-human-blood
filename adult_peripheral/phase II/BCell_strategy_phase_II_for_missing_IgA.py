...
if __name__ == '__main__':
    ...
    index_file = ag.pd.read_csv("/media/ludvig/cbio3/projects/GAIM/06-12-18_BCell_phase_II/missing_ab_index/lowIgA_index.txt", sep='\t',header=None)[0].tolist()
    ...
    BCell_exp.printExperiment("/media/ludvig/Project_Storage/BloodVariome/aligater_output/phase_II_BCell_phase_II_06-12-2018_missing_IgA.txt")
