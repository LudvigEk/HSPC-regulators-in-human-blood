...
def gateBCellDataSet(fcs, *args, **kwargs):
    ...
    #CD34pos
    CD34step1=ag.gateTiltedLine(fcs,xCol="CD34",yCol="CD45",name="CD45pos",parentGate=PBMC,startPoint=(xlim, ylim),theta=70, endLimits=(None,None), population='lower', scale='bilog', T=200, filePlot=None)
    CD34step2=ag.gateTiltedLine(fcs, xCol="CD34",yCol="CD45",name="CD34step2",parentGate=CD34step1,startPoint=(xlim, ylim),theta=-60, endLimits=(None,200), population='upper', scale='bilog', T=200, filePlot=None)
...
if __name__ == '__main__':
    ...
    #index_file = ag.pd.read_csv("/media/ludvig/Project_Storage/BloodVariome/data/Phase_II/local_Phase2_index.txt", sep='\t')['local_path'].tolist()
    index_file = ag.pd.read_csv("/media/ludvig/cbio3/projects/GAIM/06-12-18_BCell_phase_II/failed_compensation/failed_comp_full_strategy_index.txt", sep='\t',header=None)[0].tolist()
    ...
    BCell_exp.printExperiment("/media/ludvig/Project_Storage/BloodVariome/aligater_output/phase_II_BCell_phase_II_06-12-2018_rerun_comp.txt")
